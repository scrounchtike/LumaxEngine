...
struct AddComponent{
	template <typename Component>
	static void execute(Level<TSystemList, TRenderingSystem2DList, TRenderingSystem3DList, TRenderPass2DList, TRenderPass3DList>* level, uint32 entity, luabridge::LuaRef r){
...
class LuaLevelLoader {
	static Level<TSystemList, TRenderingSystem2DList, TRenderingSystem3DList, TRenderPass2DList, TRenderPass3DList>* level;
public:
	static void initLoader();
	
	static Level<TSystemList, TRenderingSystem2DList, TRenderingSystem3DList, TRenderPass2DList, TRenderPass3DList>* loadLevel(const std::string& levelName);
private:
	...
	using ComponentAdder = AddComponent<TSystemList, TRenderingSystem2DList, TRenderingSystem3DList, TRenderPass2DList, TRenderPass3DList>;
